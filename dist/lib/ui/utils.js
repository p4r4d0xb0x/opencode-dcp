...
function extractParameterKey(tool, parameters) {
    if (!parameters)
        return "";
...
export function formatProgressBar(messageIds, prunedMessages, recentMessageIds, width = 50) {
    const ACTIVE = "█";
    const PRUNED = "░";
    const RECENT = "⣿";
...
export function cacheSystemPromptTokens(state, messages) {
