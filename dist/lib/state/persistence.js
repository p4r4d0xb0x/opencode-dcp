        ...
        const state = {
            ...
            prune: {
                ...
                messages: {
                    ...
                    blocksById: Object.fromEntries(Array.from(sessionState.prune.messages.blocksById.entries()).map(([blockId, block]) => [String(blockId), block])),
                    activeBlockIds: Array.from(sessionState.prune.messages.activeBlockIds),
                    activeByAnchorMessageId: Object.fromEntries(sessionState.prune.messages.activeByAnchorMessageId),
